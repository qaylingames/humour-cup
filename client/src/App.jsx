...
const uiTranslations = {
  'English': { 
    ...
    donateClarify: "If you want to buy perks while donating, then buy Humour Cup GOLD. But if you want to support my work, please donate here. 💙", customAmt: "Enter amount", emailPlace: "Enter your email address...", payRazor: "Pay via Razorpay", payPaddle: "Pay via Paddle (Global)", payUpi: "Pay via UPI ID (India)",
  ...
  'Hindi': { 
    ...
    donateClarify: "यदि आप दान करते समय अनुलाभ (perks) खरीदना चाहते हैं, तो ह्यूमर कप गोल्ड खरीदें। लेकिन अगर आप समर्थन करना चाहते हैं, तो कृपया यहां दान करें। 💙", customAmt: "राशि दर्ज करें", emailPlace: "अपना ईमेल पता दर्ज करें...", payRazor: "Razorpay से भुगतान करें", payPaddle: "Paddle से भुगतान करें (वैश्विक)", payUpi: "UPI से भुगतान करें (भारत)",
  ...
  'Spanish': { 
    ...
    donateClarify: "Si quieres ventajas al donar, compra Humour Cup GOLD. Pero si solo quieres apoyar, dona aquí. 💙", customAmt: "Cantidad", emailPlace: "Tu correo electrónico...", payRazor: "Pagar vía Razorpay", payPaddle: "Pagar vía Paddle (Global)", payUpi: "Pagar vía UPI (India)",
  ...
  'Mandarin': { 
    ...
    donateClarify: "如果您想在捐赠时获得特权，请购买 Humour Cup GOLD。但如果您只是想支持我，请在这里捐赠。 💙", customAmt: "输入金额", emailPlace: "您的电子邮件地址...", payRazor: "通过 Razorpay 支付", payPaddle: "通过 Paddle 支付 (全球)", payUpi: "通过 UPI 支付 (印度)",
  ...
  'Arabic': { 
    ...
    donateClarify: "إذا كنت ترغب في شراء الامتيازات أثناء التبرع، فقم بشراء Humour Cup GOLD. ولكن إذا كنت ترغب في الدعم، يرجى التبرع هنا. 💙", customAmt: "المبلغ", emailPlace: "أدخل بريدك الإلكتروني...", payRazor: "ادفع عبر Razorpay", payPaddle: "ادفع عبر Paddle (عالمي)", payUpi: "ادفع عبر UPI (الهند)",
  ...
  'Portuguese': { 
    ...
    donateClarify: "Se você quer vantagens, compre o Humour Cup GOLD. Mas se você só quer apoiar meu trabalho, doe aqui. 💙", customAmt: "Valor", emailPlace: "Seu endereço de e-mail...", payRazor: "Pagar via Razorpay", payPaddle: "Pagar via Paddle (Global)", payUpi: "Pagar via UPI (Índia)",
  ...
  'German': { 
    ...
    donateClarify: "Wenn du beim Spenden Vorteile erhalten möchtest, kaufe Humour Cup GOLD. Wenn du mich nur unterstützen möchtest, spende bitte hier. 💙", customAmt: "Betrag", emailPlace: "Deine E-Mail-Adresse...", payRazor: "Mit Razorpay bezahlen", payPaddle: "Mit Paddle bezahlen (Global)", payUpi: "Mit UPI bezahlen (Indien)",
  ...
  'Korean': { 
    ...
    donateClarify: "후원하면서 혜택을 원하시면 Humour Cup GOLD를 구매해주세요. 하지만 단순히 지원을 원하시면 여기서 후원해주세요. 💙", customAmt: "금액", emailPlace: "이메일 주소...", payRazor: "Razorpay 결제", payPaddle: "Paddle 결제 (글로벌)", payUpi: "UPI 결제 (인도)",
  ...
  'Indonesian': { 
    ...
    donateClarify: "Kalau mau dapet fitur tambahan, beli Humour Cup GOLD. Tapi kalau cuma mau dukung karyaku, donasi di sini ya. 💙", customAmt: "Jumlah", emailPlace: "Alamat email kamu...", payRazor: "Bayar via Razorpay", payPaddle: "Bayar via Paddle (Global)", payUpi: "Bayar via UPI (India)",
  ...
  'Russian': { 
    ...
    donateClarify: "Если вы хотите получить бонусы за донат, купите Humour Cup GOLD. Но если вы просто хотите меня поддержать, сделайте донат здесь. 💙", customAmt: "Сумма", emailPlace: "Ваш email...", payRazor: "Оплатить через Razorpay", payPaddle: "Оплатить через Paddle (Мир)", payUpi: "Оплатить через UPI (Индия)",
...
const styles = {
  ...
  donateBtn: { display: 'inline-block', background: '#ff5e5b', color: '#ffffff', padding: '15px 30px', borderRadius: '50px', border: '4px solid #1a1a1a', fontSize: '18px', fontWeight: '900', cursor: 'pointer', boxShadow: '6px 6px 0px #1a1a1a', textDecoration: 'none', marginTop: '40px', border: 'none', outline: 'none' },
