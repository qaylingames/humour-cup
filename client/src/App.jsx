...
function App() {
  ...
  return (
    <div onClick={unlockAudio} style={styles.appWrapper}>
      ...
      <div style={{...styles.container, paddingBottom: '40px', flex: '1 0 auto'}}>
