...
const styles = {
  ...
  logoImg: { height: '120px', width: 'auto', marginBottom: '10px', cursor: 'pointer', userSelect: 'none', filter: 'drop-shadow(4px 4px 0px #1a1a1a)' },
