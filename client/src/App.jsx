  ...
  return (
    <div onClick={unlockAudio} style={styles.appWrapper}>
      <style>{`
        ...
        /* NEW: Impactful wobbling animation for the text */
        @keyframes toingWobble {
        ...
        .animated-logo { animation: toingWobble 6s infinite ease-in-out; }

        /* NEW: Shining Diamond sparks animation */
        @keyframes sparkShine {
            0%, 100% { transform: scale(1) rotate(0deg); opacity: 0.7; }
            50% { transform: scale(1.3) rotate(20deg); opacity: 1; filter: drop-shadow(0 0 5px #FFC200); }
        }
        .diamond-spark { position: absolute; animation: sparkShine 4s infinite ease-in-out; z-index: 10; }
        .spark-1 { top: 30px; left: 100px; animation-delay: 0s; }
        .spark-2 { top: 45px; right: 110px; animation-delay: 1.5s; }
        .spark-3 { top: 120px; left: 150px; animation-delay: 3s; }
        .spark-4 { top: 100px; right: 170px; animation-delay: 0.5s; }
        .spark-5 { top: 85px; left: 240px; animation-delay: 2s; /* Secret spark on teeth */ }
      `}</style>
      ...
      {/* --- REPLACED LOGO WITH NEW IMPACTFUL ANIMATED IMAGE & SPARKS --- */}
      <div style={styles.container}>
         <div style={styles.logoWrapper}>
            ...
            />
            {/* Animated Shining Diamonds */}
            <span className="diamond-spark spark-1" style={styles.sparkText}>✦</span>
            <span className="diamond-spark spark-2" style={styles.sparkText}>✨</span>
            <span className="diamond-spark spark-3" style={styles.sparkText}>✦</span>
            <span className="diamond-spark spark-4" style={styles.sparkText}>✨</span>
            <span className="diamond-spark spark-5" style={styles.sparkText}>✦</span>
         </div>
...
const styles = {
  ...
  logoWrapper: { position: 'relative', height: '260px', width: 'auto', marginBottom: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center' },
  logoImg: { height: '100%', width: 'auto', cursor: 'pointer', userSelect: 'none', filter: 'drop-shadow(6px 6px 0px #1a1a1a)' },
  sparkText: { fontSize: '28px', color: '#ffffff', filter: 'drop-shadow(2px 2px 0px #1a1a1a)', pointerEvents: 'none', userSelect: 'none', position: 'absolute' },
  ...
  container: { width: '100%', maxWidth: '500px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', paddingTop: '10px', paddingBottom: '60px' },
